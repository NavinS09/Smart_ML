...
def home():
    ...
    st.write(":telephone_receiver: 9786710266")
    st.write(":e-mail: contact@navin2002.com")
    st.write(":iphone: [https://www.linkedin.com/in/navins/](https://www.linkedin.com/in/navins/)")
